    ...
    const subscriptionPlans = [
        {
            id: 1,
            name: 'ELEMENT PLAN',
            subtitle: 'Essential Interiors',
            price: '₹140–₹180',
            duration: 'per sq.ft',
            description: 'Perfect for first-time homeowners, rental flats, or small office setups.',
            features: [
                'Duration: 1 Month',
                'Consultations: 3–4 Fixed Meetings',
                'Essential Space Layout Design',
                'Basic Theme & Color Palette',
                'Budget-Friendly Material Suggestions',
                'Basic 2D Layout',
                '1 Free Revision',
                'Add-ons: 3D design, extra revisions, material sourcing'
            ],
            popular: false,
            icon: (
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
        ...
        },
        {
            id: 2,
            name: 'AXIS PLAN',
            subtitle: 'Advanced Interiors',
            price: '₹160–₹210',
            duration: 'per sq.ft',
            description: 'Perfect for mid-size homes, cafés, boutiques, or startups.',
            features: [
                'Duration: 2 Months',
                'Consultations: 6 Meetings (Flexible Schedule)',
                '4 Free Site Visits',
                'Free Consultation + Detailed 2D & 3D Concepts',
                'Material & Vendor Suggestions (Free)',
                'Product Purchase Guidance',
                'Space Planning + Lighting Plan',
                '2 Free Revision Rounds',
                'Add-on: 1 Free Branding Suggestion for café/office'
            ],
            popular: true,
            icon: (
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
        ...
        {
            id: 3,
            name: 'ONEAXIS SIGNATURE',
            subtitle: 'Luxury Interiors',
            price: '₹230–₹300',
            duration: 'per sq.ft',
            description: 'Perfect for villas, offices, premium residences & full-brand setups.',
            features: [
                'Duration: 3–4 Months',
                'Consultations: Unlimited (Flexible Schedule)',
                '6 Complimentary Site Visits',
                'Full 3D Visualization for Each Area',
                'Dedicated Designer & Project Manager',
                'Premium Material Selection Support',
                'Vendor Management & On-site Supervision',
                'Branding & Theme Strategy (if commercial)',
                'Installation Assistance',
                'Unlimited Revisions (During project)',
                'Bonus: Custom Moodboard',
                'After-Completion Styling Session'
            ],
            popular: false,
            icon: (
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    ...
    return (
        <div className="interior-design-page">
            ...
            <div className="interior-section interior-section-2" style={{ zIndex: 2 }}>
                ...
                <section className="interior-subscriptions">
                    <div className="interior-subscriptions-header">
                        <span className="interior-section-label">Investment Plans</span>
                        <h2 className="interior-section-title">Choose Your Design Package</h2>
                        <p className="interior-subscriptions-subtitle">
                            Transparent pricing with comprehensive features tailored to your needs
                        </p>
                    </div>

                    <div className="interior-subscriptions-grid">
                        {subscriptionPlans.map((plan) => (
                            <div 
                                key={plan.id} 
                                className={`interior-subscription-card ${plan.popular ? 'popular' : ''}`}
                            >
                                {plan.popular && (
                                    <div className="interior-subscription-badge">
                                        Most Popular
                                    </div>
                                )}
                                
                                <div className="interior-subscription-icon">
                                    {plan.icon}
                                </div>

                                <div className="interior-subscription-header">
                                    <h3 className="interior-subscription-name">{plan.name}</h3>
                                    <p className="interior-subscription-subtitle">{plan.subtitle}</p>
                                </div>

                                <div className="interior-subscription-pricing">
                                    <div className="interior-subscription-price">{plan.price}</div>
                                    <div className="interior-subscription-duration">{plan.duration}</div>
                                </div>

                                <p className="interior-subscription-description">{plan.description}</p>

                                <ul className="interior-subscription-features">
                                    {plan.features.map((feature, idx) => (
                                        <li key={idx} className="interior-subscription-feature">
                                            <svg viewBox="0 0 20 20" fill="currentColor" className="interior-feature-check">
                                ...
                                <button className="interior-subscription-btn" onClick={openContactModal}>
                                    Get Started
                                    <svg viewBox="0 0 20 20" fill="currentColor" className="interior-btn-arrow">
                    ...
                    <div className="interior-subscriptions-note">
                        <p>
                            <strong>Note:</strong> All packages include initial consultation and can be customized to your specific requirements. 
