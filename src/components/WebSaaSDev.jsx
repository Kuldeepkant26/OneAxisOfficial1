...
import { FaChrome, FaLock, FaEllipsisH, FaChartLine, FaUsers, FaCog } from 'react-icons/fa';
    ...
    <section className={`websaas-section ${isDark ? 'dark' : ''}`}>
      <div className="websaas-container">
                ...
                <div className="dashboard-chart">
                  ...
                  <div className="chart-bars">
                    <div className="bar-group">
                      <div className="bar primary" style={{ height: '60%' }}></div>
                      <div className="bar secondary" style={{ height: '45%' }}></div>
                    </div>
                    <div className="bar-group">
                      <div className="bar primary" style={{ height: '75%' }}></div>
                      <div className="bar secondary" style={{ height: '60%' }}></div>
                    </div>
                    <div className="bar-group">
                      <div className="bar primary" style={{ height: '85%' }}></div>
                      <div className="bar secondary" style={{ height: '70%' }}></div>
                    </div>
                    <div className="bar-group">
                      <div className="bar primary" style={{ height: '95%' }}></div>
        ...
        <div className="websaas-right">
          ...
          <button className="websaas-learn-more" onClick={openContactModal}>
            Get Started
          </button>
        </div>
      </div>
