                ...
                <div className="footer-top">
                    <div className="footer-brand">
                        ...
                        <div className="footer-social">
                            <a href="https://www.linkedin.com/in/oneaxis-solutions-695991394" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="LinkedIn">
                                <FaLinkedinIn />
                            </a>
                            <a href="https://x.com/home" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="Twitter">
                                <FaTwitter />
                            </a>
                            <a href="https://www.instagram.com/accounts/edit/" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="Instagram">
                                <FaInstagram />
                            </a>
                            <a href="https://www.facebook.com/profile.php?id=61582456516681" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="Facebook">
                                <FaFacebookF />
                            </a>
                        </div>
                    </div>
                        ...
                        <div className="footer-column">
                            ...
                            <ul className="footer-contact">
                                ...
                                <li>
                                    ...
                                    <a href="tel:+918449844995">+91 84498 44995<br></br>
                                        +91 89545 35455
                                    </a>
                                </li>
